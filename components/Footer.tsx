        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about-event" className="text-gray-300 hover:text-white transition-colors duration-300">
                  About Event
                </Link>
              </li>
              <li>
                <Link href="/registration" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Registration
                </Link>
              </li>
              <li>
                <Link href="/organizors" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Organizers
                </Link>
              </li>
              <li>
                <Link href="/sponsorships" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Sponsorships
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/awards" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Awards
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              <p className="mb-2">Department of Metallurgical & Materials Engineering</p>
              <p className="mb-2">Indian Institute of Technology Kharagpur</p>
